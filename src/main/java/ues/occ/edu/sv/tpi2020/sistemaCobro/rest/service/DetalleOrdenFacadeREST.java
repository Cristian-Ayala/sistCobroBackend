...
public class DetalleOrdenFacadeREST extends AbstractFacade<DetalleOrden> {
    ...
    private DetalleOrdenPK getPrimaryKey(PathSegment pathSegment) {
         ...
         * URI path part is supposed to be in form of 'somePath;idOrden=idOrdenValue;upc=upcValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        ues.occ.edu.sv.tpi2020.sistemaCobro.entities.DetalleOrdenPK key = new ues.occ.edu.sv.tpi2020.sistemaCobro.entities.DetalleOrdenPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        ues.occ.edu.sv.tpi2020.sistemaCobro.entities.DetalleOrdenPK key = getPrimaryKey(id);
